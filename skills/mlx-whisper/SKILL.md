...
| # | 模型 | 大小 | 速度 | 准确率 | 适合场景 |
|---|------|------|------|--------|---------|
| 1 | base | ~140MB | 很快 | 一般 | 快速试用，先看效果 |
| 2 | small | ~460MB | 快 | 良好 | 快速预览，准确率要求不高 |
| 3 | large-v3-turbo | ~800MB | 较快 | 优秀 | **推荐**，速度和质量平衡 |
| 4 | large-v3 | ~3GB | 慢 | 最佳 | 最终版，最高准确率 |
| 5 | large-v2 | ~3GB | 慢 | 很好 | 备用，某些场景更稳 |
